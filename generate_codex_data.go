...
var modelPricingUSDPerM = []pricingRule{
	...
	{label: "gpt-5.6 sol", patterns: []string{"gpt-5.6-sol", "gpt_5_6_sol", "gpt 5.6 sol", "gpt-5.6", "gpt_5_6", "gpt 5.6"}, input: 4.00, cached: 0.40, output: 20.00},
	{label: "gpt-5.6 terra", patterns: []string{"gpt-5.6-terra", "gpt_5_6_terra", "gpt 5.6 terra"}, input: 2.00, cached: 0.20, output: 12.00},
	{label: "gpt-5.6 luna", patterns: []string{"gpt-5.6-luna", "gpt_5_6_luna", "gpt 5.6 luna"}, input: 0.20, cached: 0.02, output: 1.20},
